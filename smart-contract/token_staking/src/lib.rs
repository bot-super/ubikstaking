...
declare_id!("8h6FVYBoSNKYVMRKp7DvjHdkvkcyrK8ug8TibtiSorkc");
...
pub mod token_staking{
    ...
    pub fn stake(
        ...
        token::transfer(cpi_ctx, amount)?;
        let new_reward_amount = (staking_data.stake_amount as u128 * pool.apy as u128 / 10000 * (clock - staking_data.last_time) as u128 / pool.period as u128) as u64;
...
pub const POOL_SIZE : usize = 32+32+32+32+8+8+8+1+40;
pub const STAKING_DATA_SIZE : usize = 32+32+8+8+8+1+40;
